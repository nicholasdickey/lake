...
const Qwiket = ({ session, qparams, item, isTopic }: { session: Options, qparams: Qparams, item: any, isTopic: boolean }) => {
    ...
    if (isReact) {
        ...
        return <VerticalWrap>
            ...
            <Row><ImageBox><NextImage placeholder={"blur"} blurDataURL={'https://qwiket.com/static/css/afnLogo.png'} style={{objectFit:"cover"}} data-id={"NexuImg"} src={image} alt={"NextImg:"+title} fill={true} /></ImageBox></Row>
