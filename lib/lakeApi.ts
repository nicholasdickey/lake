...
export const fetchChannelConfig = (slug: string) => {
...
export const fetchChannelLayout = ([u, slug, hasLayout, sessionid, userslug, type, dense, thick, layoutNumber]: [u: string, slug: string, hasLayout: boolean, sessionid: string, userslug: string, type: string, dense: number, thick: number, layoutNumber: string]) => {
...
export const fetchUser = ([u, userslug]: [u: string, userslug: string]) => {
