...
const Notifications = ({ isLeft, qType, newsline, forum, lastid, tail, sessionid, userslug, reset, tag, ...props }:
    ...
    const key = ['notif', qType, newsline, qparams.type == 'solo' ? 1 : 0, forum, (qType == 'tag' || qparams.type == 'solo') ? qparams.tag : '', 0, lastid, sessionid, userslug, tail,'','',0,'',isLeft];
